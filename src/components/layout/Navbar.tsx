...
const navItems: NavItem[] = [
  {
    ...
    items: [
      ...
      { label: 'Building a Foundation for Success', href: '/about' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Financial Aid', href: '/financing' },
    ],
  },
  {
    label: 'Our Courses',
    wide: true,
    items: [
      { label: 'All Certificate Programs (40+)', href: '/programs' },
  ...
  },
  {
    label: 'Beauty Clinic',
    items: [
      { label: 'Beauty Clinic', href: '/clinic' },
      { label: 'Mississauga Spa Services', href: '/campuses/mississauga' },
      { label: 'Waterloo Spa Services', href: '/campuses/waterloo' },
      { label: 'Waterloo Hair Design', href: '/campuses/waterloo' },
      { label: 'Ottawa Spa Services', href: '/campuses/ottawa' },
    ],
  },
  {
    label: 'Gallery',
